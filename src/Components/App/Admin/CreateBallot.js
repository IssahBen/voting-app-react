...
export default function CreateBallot(){
    ...
    const {CreateBallot} = useData()
    const [description,setDescription] = useState("")
    const [title,setTitle] = useState("")
    async function handleCreate(e){
        e.preventDefault()
        const obj ={ballot:{name:title,description:description}}
       const status = await  CreateBallot(obj)
       if (status === "success"){
            navigate("/admin")
       }
    }
            return(<div class="bg-black text-white flex min-h-screen flex-col items-center pt-16 sm:justify-center mt-5 sm:pt-0">
            ...
            <div class="relative mt-12 w-full max-w-lg sm:mt-10">
                ...
                <div
                    ...
                    <div class="flex flex-col p-6">
                        <h3 class="text-xl font-semibold leading-6 tracking-tighter">WeVote</h3>
                            ...
                            <div>
                                <div>
                                    <div
                                        ...
                                        <input type="text" name="title" placeholder="" value={title} onChange={(e)=> setTitle(e.target.value)}
                                            autocomplete="off"
                            ...
                            <div class="mt-4">
                                <div>
                                    <div
                                        ...
                                        <div class="flex justify-between">
                                            <label
                                                class="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Description</label>
                                        </div>
