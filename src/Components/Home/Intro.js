function Intro({ setStatus }) {
  return (
    <div className="flex flex-col items-center p-8 space-y-10 mt-24">
      ...
      <div className="flex md:justify-start justify-center py-2  opacity-80  ">
        <div className="bg-white flex  flex-col items-center py-5 px-8 shadow   border-[5px]  border-yellow-600 border-t-0  border-b-0 rounded-lg">
